          ...
          <SettingsSection title={t("settings.egress.mihomo")}>
            <div className="space-y-0">
              ...
              {draftMihomoEnabled ? <>
                ...
                <SettingsField controlId="egress-mihomo-test-group-name" className="sm:col-span-2" label={t("settings.web.mihomoTestGroupName")} description={t("settings.web.mihomoTestGroupNameHelp")} error={form.formState.errors.providerWeb?.mihomoTestGroupName?.message}><Input id="egress-mihomo-test-group-name" placeholder="XAI-TEST-GROUP" {...form.register("providerWeb.mihomoTestGroupName")} /></SettingsField>
                <SettingsField controlId="egress-mihomo-test-proxy-url" className="sm:col-span-2" label={t("settings.web.mihomoTestProxyURL")} description={t("settings.web.mihomoTestProxyURLHelp")} error={form.formState.errors.providerWeb?.mihomoTestProxyURL?.message}><Input id="egress-mihomo-test-proxy-url" type="url" placeholder="http://grok-mihomo:7891" {...form.register("providerWeb.mihomoTestProxyURL")} /></SettingsField>
                <SettingsField controlId="egress-mihomo-delay-probe-url" className="sm:col-span-2" label={t("settings.web.mihomoDelayProbeURL")} description={t("settings.web.mihomoDelayProbeURLHelp")} error={form.formState.errors.providerWeb?.mihomoDelayProbeURL?.message}><Input id="egress-mihomo-delay-probe-url" type="url" placeholder="https://captive.apple.com/hotspot-detect.html" {...form.register("providerWeb.mihomoDelayProbeURL")} /></SettingsField>
              </> : null}
