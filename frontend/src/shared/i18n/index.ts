  ...
  "zh-CN": {
    translation: {
      ...
      qualityGuard: {
        ...
        mihomoGroupExit: "Mihomo 组出口", mihomoGroupExitHelp: "组出口共享：切换/封禁影响所有使用该出口的流量。", mihomoSwitchConfirmHelp: "切换到当前延迟最优且未被封禁的节点。切换影响所有使用该出口的流量。", mihomoRotate: "强制轮换", mihomoRotateHelp: "为整个共享出口强制更换出口节点与 IP。", mihomoRotateConfirmTitle: "轮换整个组出口？", mihomoRotateConfirmDescription: "将强制轮换共享出口，所有使用该出口的流量会短暂中断并切换到新节点。此操作无法撤销。",         mihomoSelectMember: "选中节点", mihomoBanMember: "封禁", mihomoUnbanMember: "解封", mihomoMemberSelected: "已选中节点", mihomoBanned: "已封禁所选节点", mihomoUnbanned: "已解封所选节点", mihomoRotated: "已轮换共享出口", mihomoNoMembers: "组内暂无成员", mihomoGuardLink: "守卫联动", mihomoGuardLinkHelp: "测试组成员已同步为同名 DB 出口节点；徽章显示质量守护对它的隔离/健康状态，可一键将其设为测试出口。", mihomoNotSynced: "未同步到 DB", mihomoUseAsExit: "设为测试出口",
      },
      policyEditor: { rotationSection: "轮换配置", rotationUrl: "轮换接口 URL", rotationUrlHelp: "质量守护调用以轮换共享出口的接口地址，留空则禁用轮换。", rotatableNodeIds: "可轮换节点", rotatableNodeIdsHelp: "允许参与轮换的 Mihomo 节点，多个用英文逗号分隔。" },
      accounts: {
        title: "上游账号",
      ...
      apiErrors: {
        ...
        accountConversionBusy: "账号转换正在进行中",
        ...
        accountPoolValidationFailed: "校验账号号池失败",
        ...
        clearanceRefreshFailed: "刷新 Clearance 失败",
        clearanceRefreshUnavailable: "Clearance 刷新暂不可用",
        clientKeyConflict: "客户端密钥名称冲突",
        clientKeyDeleteFailed: "删除客户端密钥失败",
        clientKeySystemManaged: "系统托管的客户端密钥不可修改",
        egressConflict: "出口节点名称已存在",
        egressMihomoUnavailable: "Mihomo 出口切换暂不可用",
        ...
        egressProbeStale: "探测结果已过期",
        egressQualityProbeFailed: "质量检测暂不可用，请稍后重试",
        egressQualityProbeNoAccount: "质量检测暂无可调度账号，请稍后重试",
        egressQualityProbeUnavailable: "质量探测暂不可用",
        egressSourceListFailed: "读取代理订阅来源失败",
        egressSubscriptionSyncFailed: "代理订阅同步失败",
        invalidAccountScope: "无效的账号作用域",
        invalidAuditPeriod: "period 仅支持 24h、7d、30d、90d",
        invalidClientKeyId: "Client Key ID 无效",
        invalidDashboardTimezone: "timezone 必须是有效的 IANA 时区",
        invalidEgressNode: "无效的出口节点",
        invalidImageSelection: "无效的图片选择",
        invalidLinkedDeleteTargets: "无效的关联删除目标",
        invalidProvider: "无效的账号提供方",
        invalidQualityGuardConfig: "无效的质量守护配置",
        invalidSort: "无效的排序参数",
        invalidVideoSelection: "无效的视频选择",
        ...
        modelConflict: "模型名称冲突，请更换后重试",
        modelNotFound: "模型不存在或已被删除",
        qualityGuardConfigWriteFailed: "质量守护策略保存失败",
        qualityGuardReadOnly: "质量守护策略当前只读",
        qualityGuardUnauthorized: "质量守护内部认证失败",
        qualityGuardUnavailable: "质量守护服务暂不可用",
        quotaBatchRefreshFailed: "批量同步账号额度失败",
  ...
  en: {
    translation: {
      ...
      apiErrors: {
        ...
        accountConversionBusy: "Account conversion is in progress",
        accountDeleteFailed: "Failed to delete the account",
        accountDeletionPreviewFailed: "Failed to preview account deletion",
        ...
        accountPoolMismatch: "The batch operation includes accounts outside the current account pool",
        accountPoolValidationFailed: "Failed to validate the account pool",
        ...
        authRuntimeUnavailable: "Admin authentication service is unavailable",
        clearanceRefreshFailed: "Failed to refresh Clearance",
        clearanceRefreshUnavailable: "Clearance refresh is unavailable",
        clientKeyConflict: "Client key name conflict",
        clientKeyDeleteFailed: "Failed to delete the client key",
        clientKeySystemManaged: "System-managed client keys cannot be modified",
        egressConflict: "An egress node with this name already exists",
        egressMihomoUnavailable: "Mihomo egress switching is unavailable",
        ...
        egressOperationsUnavailable: "Proxy operations are unavailable",
        egressProbeStale: "The probe result is stale",
        egressQualityProbeFailed: "Quality probing is temporarily unavailable. Please retry shortly.",
        egressQualityProbeNoAccount: "No account is available for quality probing. Please retry shortly.",
        egressQualityProbeUnavailable: "Quality probe is unavailable",
        egressSourceListFailed: "Failed to load proxy subscription sources",
        egressSubscriptionSyncFailed: "Proxy subscription sync failed",
        invalidAccountScope: "Invalid account scope",
        invalidAuditPeriod: "period only supports 24h, 7d, 30d, and 90d",
        invalidClientKeyId: "The client key ID is invalid",
        invalidDashboardTimezone: "The timezone must be a valid IANA timezone",
        invalidEgressNode: "Invalid egress node",
        invalidImageSelection: "Invalid image selection",
        invalidLinkedDeleteTargets: "Invalid linked deletion targets",
        invalidProvider: "Invalid account provider",
        invalidQualityGuardConfig: "Invalid quality guard configuration",
        invalidSort: "Invalid sort parameter",
        invalidVideoSelection: "Invalid video selection",
        loginRateLimited: "Too many login attempts. Please retry shortly.",
        ...
        mediaListImagesFailed: "Failed to load the image list",
        mediaListVideosFailed: "Failed to load the video job list",
        mediaVideoStatsFailed: "Failed to load video statistics",
        modelConflict: "Model name conflict. Please change it and retry.",
        modelNotFound: "Model not found or deleted",
        qualityGuardConfigWriteFailed: "Failed to save the quality guard policy",
        qualityGuardReadOnly: "The quality guard policy is currently read-only",
        qualityGuardUnauthorized: "Quality guard internal authentication failed",
        qualityGuardUnavailable: "Quality guard service is unavailable",
        quotaBatchRefreshFailed: "Failed to sync account quotas in batch",
        settingsConflict: "Settings were updated by another session. Please refresh and retry.",
      },
    },
  },
} as const;
...
Object.assign(resources["zh-CN"].translation.settings.egress as unknown as Record<string, string>, {
  ...
  type: "类型",
  typeHelp: "标准节点为独立出口代理；Mihomo 类型节点通过本地 Mihomo 组出口共享流量，质量守卫不会探测或隔离此类节点。",
  typeStandard: "标准",
  typeMihomo: "Mihomo 组通道",
});
